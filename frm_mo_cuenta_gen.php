...
<body>
	<form action="">
		<div class="cl_movxcta" name="c_movxcta" id="id_movxcta">
			<table>
				<tr>
					<td colspan="5" align="center"><h3 style="margin:20px auto; border-bottom: solid 2px #e89980;">MOVIMIENTOS DE CUENTAS GENERAL</h3></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="right"><input type="button" name="c_movbuscar" id="id_movbuscar" value="Buscar Mov." onclick="reportemovcuentas_gen();"></td>
				</tr>
				<tr>
					<td colspan="11">

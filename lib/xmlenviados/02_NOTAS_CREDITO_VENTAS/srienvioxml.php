...
if (isset($_SESSION ['nombres']) and isset($_SESSION['user']) and isset($_SESSION['empresa']) and isset($_SESSION['cargo']) and isset($_SESSION['id_user'])) {
	...
	//echo $nf ;
		...
		echo '<script>document.location.href="http://181.113.67.126:2015/bddfacturacion_agromundosc/inicio.php?id=frm_administrar_comprobante.php&idcomprobante='.$idcomprobante.'&num_comprob_Fac='.$nf.'"</script>';
	}
	else
	{
		echo "<script>

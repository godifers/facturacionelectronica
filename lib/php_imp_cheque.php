...
// echo "<b>".$con."</b>"; 
 $numen_letra =numtoletras($total);

	$pdf = new FPDF('L','mm',array(152, 75));
	...
	$pdf->SetFont('Arial', '', 9);
	$pdf->Cell(18, 5, '',0,0,'R');
	$pdf->Cell(96, 5, $res_chque[2],0,0,'L');
    $pdf->Cell(5, 5, '',0,0,'R');
	$pdf->Cell(30, 5, $res_chque[1],0,0,'L');

	$pdf->Ln(6);
	$pdf->SetFont('Arial', '', 9);
	$pdf->Cell(18, 5, '',0,0,'R');
	$pdf->Cell(100, 5, $numen_letra,0,0,'L');
	...
	$pdf->SetFont('Arial', '', 9);
	$pdf->Cell(8, 5, '',0,0,'R');
	$pdf->Cell(100, 5, 'TULCAN.  '. date('Y-m-d', strtotime(str_replace('/', '-', $res_chque[3])) ),0,0,'L');

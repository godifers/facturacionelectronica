...
<body>
	<form action="lib/php_ingre_egreso.php"  method="post" autocomplete="off">		
			<div class="cl_datosrecibo" >
				<table border="0">
					<tr>
						<td colspan="4" align="center"><h3 style="margin:20px auto; border-bottom: solid 2px #e89980;">ADMINISTRACION DE INGRESOS</h3></td>										
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2">
							...
							<input type="hidden" class="cl_txthidden" name="c_identificador_ingresos_egresos" value="I" class="cl_txt" readonly/>
